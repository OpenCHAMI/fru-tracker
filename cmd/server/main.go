...
import (
	...
	. "github.com/example/inventory-api/internal/middleware"
	

	
	"github.com/openchami/fabrica/pkg/reconcile"
	"github.com/example/inventory-api/pkg/reconcilers"
...
func runServer(cmd *cobra.Command, args []string) error {
	...
	if eventConfig.EventTypePrefix == "" {
		eventConfig.EventTypePrefix = "inventory-api.resource"
	}
