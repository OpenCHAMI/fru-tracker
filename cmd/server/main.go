...
// Generated: 2026-02-26T11:09:26-08:00
//
...
import (
	...
	_ "github.com/example/fru-tracker/pkg/apiversion"
	"github.com/openchami/fabrica/pkg/versioning"
	 ...
	 "github.com/example/fru-tracker/internal/storage/ent/migrate"
	...
	. "github.com/example/fru-tracker/internal/middleware"
	

	
	"github.com/openchami/fabrica/pkg/reconcile"
	"github.com/example/fru-tracker/pkg/reconcilers"
...
var rootCmd = &cobra.Command{
	Use:   "fru-tracker",
	Short: "",
	Long:  `fru-tracker - A Fabrica-generated OpenCHAMI service`,
	RunE:  runServer,
}

var serveCmd = &cobra.Command{
	Use:   "serve",
	Short: "Start the fru-tracker server",
	Long:  `Start the fru-tracker HTTP server with the configured options`,
	RunE:  runServer,
}
...
func init() {
	...
	// Global flags
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.fru-tracker.yaml)")
...
func initConfig() {
	...
	if cfgFile != "" {
		...
		viper.SetConfigName(".fru-tracker")
	}

	// Environment variables
	viper.SetEnvPrefix("FRU-TRACKER")
	viper.AutomaticEnv()
...
func runServer(cmd *cobra.Command, args []string) error {
	log.Printf("Starting fru-tracker server...")
	...
	if eventConfig.EventTypePrefix == "" {
		eventConfig.EventTypePrefix = "fru-tracker.resource"
	}
...
func healthHandler(w http.ResponseWriter, r *http.Request) {
	...
	w.Write([]byte(`{"status":"healthy","service":"fru-tracker"}`))
}
...
var versionCmd = &cobra.Command{
	...
	Long:  `Print the version number of fru-tracker`,
	Run: func(cmd *cobra.Command, args []string) {
		fmt.Println("fru-tracker v1.0.0")
	},
}
