...
// Generated: 2026-02-11T10:20:19-08:00
//
...
func CreateDevice(w http.ResponseWriter, r *http.Request) {
	...
	if device.Metadata.Labels == nil {
		device.Metadata.Labels = make(map[string]string)
	}
	for k, v := range req.Labels {
		device.Metadata.Labels[k] = v
	}
	if device.Metadata.Annotations == nil {
		device.Metadata.Annotations = make(map[string]string)
	}
	for k, v := range req.Annotations {
		device.Metadata.Annotations[k] = v
	}
...
func UpdateDevice(w http.ResponseWriter, r *http.Request) {
	...
	if req.Metadata.Name != "" {
		device.Metadata.Name = req.Metadata.Name
	}

	// Update spec fields ONLY - status should use /status subresource
	device.Spec = req.AsSpec()
	...
	// Update timestamp
	device.Metadata.UpdatedAt = time.Now()
	...
	if err := events.PublishResourceUpdated(r.Context(), "Device", device.Metadata.UID, device.Metadata.Name, device, updateMetadata); err != nil {
		// Log the error but don't fail the request - events are non-critical
...
func PatchDevice(w http.ResponseWriter, r *http.Request) {
	...
	if err := events.PublishResourcePatched(r.Context(), "Device", device.Metadata.UID, device.Metadata.Name, device, patchMetadata); err != nil {
		// Log the error but don't fail the request - events are non-critical
...
func UpdateDeviceStatus(w http.ResponseWriter, r *http.Request) {
	...
	var statusUpdate v1.DeviceStatus
	...
	if err := events.PublishResourceUpdated(r.Context(), "Device", res.Metadata.UID, res.Metadata.Name, res, statusMetadata); err != nil {
...
func PatchDeviceStatus(w http.ResponseWriter, r *http.Request) {
	...
	if err := events.PublishResourcePatched(r.Context(), "Device", res.Metadata.UID, res.Metadata.Name, res, patchMetadata); err != nil {
...
func DeleteDevice(w http.ResponseWriter, r *http.Request) {
	...
	if err := events.PublishResourceDeleted(r.Context(), "Device", device.Metadata.UID, device.Metadata.Name, deleteMetadata); err != nil {
		// Log the error but don't fail the request - events are non-critical
